...
export default async function ClientsPage() {
  ...
  const { data: clients } = await supabase
    .from("clients")
    .select("id, name, email, phone, is_active, monthly_request_limit, billing_day, created_at")
    .order("name");
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 hidden sm:table-cell">Telefone</th>
                <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500 hidden md:table-cell">Cobrança</th>
                <th className="px-4 py-3 text-left text-xs font-medium uppercase tracking-wider text-gray-500">Limite</th>
              ...
              {clients && clients.length > 0 ? (
                ...
                <tr>
                  <td colSpan={6} className="px-4 py-12 text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">Nenhum cliente cadastrado.</p>
                    <Link href="/admin/clients/new" className="mt-2 inline-block text-sm font-medium text-blue-600 hover:text-blue-800">
